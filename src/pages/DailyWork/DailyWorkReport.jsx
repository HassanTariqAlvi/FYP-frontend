...
const DailyWorkReport = ({ handleBack }) => {
  const { auth } = useAuth();
  const { rows, columns, details, errors, onChange, generate_report } = useReport(URLS.daily_work.generate_report);
  ...
  return (
    <>
      <ViewTemplate
        ...
        topHeading={<TopHeading title="Daily work reports" />}
      >
