...
const LoanRecoveryReport = ({ handleBack }) => {
  const { auth } = useAuth();
  const { rows, columns, details, errors, onChange, generate_report } = useReport(URLS.loan_recovery.generate_report);
  ...
  return (
    <>
      <ViewTemplate
        ...
        topHeading={<TopHeading title="Loan recovery reports" />}
      >
